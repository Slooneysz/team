...
module.exports.run = async (client, msg, args, config) => {
    if(cooldown.has(msg.author.id)) {
        ...
        fs.readFile('./accounts/nitro.txt', 'utf8', function(err, data) {
            ...
            .addField('Support Server', `https://discord.gg/wwWqWMZF`)
            ...
            .setColor("#363940")
            .setFooter('Bot made by monstis')
            .setTimestamp();

            msg.author.send(embed);

            msg.reply('I\'ve sent you the account! Please check your DM! __ Official Server Link__: https://discord.gg/wwWqWMZ')
                .then(m => {
                    setTimeout(() => {
                        m.delete();
                    }, 900000);
